...
class BasicFile implements \Aazsamir\Graphpql\Model\GraphObject
{
    ...
    /**
     * @return \Tests\Feature\Fixture\Stash\Fields\BasicFileField<mixed>
     */
    public static function id(): Fields\BasicFileField
    {
        return \Tests\Feature\Fixture\Stash\Fields\BasicFileField::id();
    }
    ...
    {
        return \Tests\Feature\Fixture\Stash\Fields\BasicFileField::path();
    }
    ...
    {
        return \Tests\Feature\Fixture\Stash\Fields\BasicFileField::basename();
    }
    ...
    {
        return \Tests\Feature\Fixture\Stash\Fields\BasicFileField::parent_folder_id();
    }
    ...
    {
        return \Tests\Feature\Fixture\Stash\Fields\BasicFileField::zip_file_id();
    }

    /**
     * @return \Tests\Feature\Fixture\Stash\Fields\BasicFileField<\Tests\Feature\Fixture\Stash\SelectionSet\FolderSelectionSet>
     */
    public static function parent_folder(): Fields\BasicFileField
    {
        return \Tests\Feature\Fixture\Stash\Fields\BasicFileField::parent_folder();
    }

    /**
     * @return \Tests\Feature\Fixture\Stash\Fields\BasicFileField<\Tests\Feature\Fixture\Stash\SelectionSet\BasicFileSelectionSet>
     */
    public static function zip_file(): Fields\BasicFileField
    {
        return \Tests\Feature\Fixture\Stash\Fields\BasicFileField::zip_file();
    }
    ...
    {
        return \Tests\Feature\Fixture\Stash\Fields\BasicFileField::mod_time();
    }
    ...
    {
        return \Tests\Feature\Fixture\Stash\Fields\BasicFileField::size();
    }

    /**
     * @return \Tests\Feature\Fixture\Stash\Fields\BasicFileField<mixed>
     */
    public static function fingerprint(string $type): Fields\BasicFileField
    {
        return \Tests\Feature\Fixture\Stash\Fields\BasicFileField::fingerprint($type,);
    }

    /**
     * @return \Tests\Feature\Fixture\Stash\Fields\BasicFileField<\Tests\Feature\Fixture\Stash\SelectionSet\FingerprintSelectionSet>
     */
    public static function fingerprints(): Fields\BasicFileField
    {
        return \Tests\Feature\Fixture\Stash\Fields\BasicFileField::fingerprints();
    }
    ...
    {
        return \Tests\Feature\Fixture\Stash\Fields\BasicFileField::created_at();
    }
    ...
    {
        return \Tests\Feature\Fixture\Stash\Fields\BasicFileField::updated_at();
    }
