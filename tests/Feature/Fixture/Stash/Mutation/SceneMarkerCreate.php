...
class SceneMarkerCreate implements \Aazsamir\Graphpql\Model\Mutation
{
    ...
    public function __construct(
        public \Tests\Feature\Fixture\Stash\SceneMarkerCreateInput $input,
    ) {
    }
    ...
    public function do(): ?\Tests\Feature\Fixture\Stash\SceneMarker
    {
    ...
    ): ?\Tests\Feature\Fixture\Stash\SceneMarker {
        if ($response->data === null) {
            return null;
        }

        return \Tests\Feature\Fixture\Stash\SceneMarker::fromArray($response->data);
    }
