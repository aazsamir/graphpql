...
class SubmitStashBoxFingerprints implements \Aazsamir\Graphpql\Model\Mutation
{
    ...
    public function __construct(
        public \Tests\Feature\Fixture\Stash\StashBoxFingerprintSubmissionInput $input,
    ) {
    }
    ...
    {
        return isset($this->selection) ? $this->selection : \Aazsamir\Graphpql\Model\NullSelectionSet::new();
    }
