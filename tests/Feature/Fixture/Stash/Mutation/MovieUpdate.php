...
class MovieUpdate implements \Aazsamir\Graphpql\Model\Mutation
{
    ...
    public function __construct(
        public \Tests\Feature\Fixture\Stash\MovieUpdateInput $input,
    ) {
    }
    ...
    public function do(): ?\Tests\Feature\Fixture\Stash\Movie
    {
    ...
    ): ?\Tests\Feature\Fixture\Stash\Movie {
        if ($response->data === null) {
            return null;
        }

        return \Tests\Feature\Fixture\Stash\Movie::fromArray($response->data);
    }
