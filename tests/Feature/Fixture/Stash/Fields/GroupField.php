...
class GroupField implements \Aazsamir\Graphpql\Model\ObjectField
{
    ...
    /**
     * @return self<\Tests\Feature\Fixture\Stash\SelectionSet\GroupDescriptionSelectionSet>
     */
    public static function containing_groups(): self
    {
        $instance = new self();
        $instance->name = 'containing_groups';
        $instance->child = new \Tests\Feature\Fixture\Stash\SelectionSet\GroupDescriptionSelectionSet();
     ...
     * @return self<mixed>
     */
    public static function sub_group_count(?int $depth): self
    {
        $instance = new self();
