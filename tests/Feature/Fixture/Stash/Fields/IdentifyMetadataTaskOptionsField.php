...
class IdentifyMetadataTaskOptionsField implements \Aazsamir\Graphpql\Model\ObjectField
{
    ...
    /**
     * @return self<\Tests\Feature\Fixture\Stash\SelectionSet\IdentifySourceSelectionSet>
     */
    public static function sources(): self
    {
        $instance = new self();
        $instance->name = 'sources';
        $instance->child = new \Tests\Feature\Fixture\Stash\SelectionSet\IdentifySourceSelectionSet();
