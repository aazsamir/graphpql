...
class ScrapeGroupURL implements \Aazsamir\Graphpql\Model\Query
{
    ...
    public function do(): ?\Tests\Feature\Fixture\Stash\ScrapedGroup
    {
    ...
    ): ?\Tests\Feature\Fixture\Stash\ScrapedGroup {
        if ($response->data === null) {
            return null;
        }

        return \Tests\Feature\Fixture\Stash\ScrapedGroup::fromArray($response->data);
    }
