...
class ScrapedMovie implements \Aazsamir\Graphpql\Model\GraphObject
{
    ...
    /**
     * @return \Tests\Feature\Fixture\Stash\Fields\ScrapedMovieField<mixed>
     */
    public static function stored_id(): Fields\ScrapedMovieField
    {
        return \Tests\Feature\Fixture\Stash\Fields\ScrapedMovieField::stored_id();
    }
    ...
    {
        return \Tests\Feature\Fixture\Stash\Fields\ScrapedMovieField::name();
    }
    ...
    {
        return \Tests\Feature\Fixture\Stash\Fields\ScrapedMovieField::aliases();
    }
    ...
    {
        return \Tests\Feature\Fixture\Stash\Fields\ScrapedMovieField::duration();
    }
    ...
    {
        return \Tests\Feature\Fixture\Stash\Fields\ScrapedMovieField::date();
    }
    ...
    {
        return \Tests\Feature\Fixture\Stash\Fields\ScrapedMovieField::rating();
    }
    ...
    {
        return \Tests\Feature\Fixture\Stash\Fields\ScrapedMovieField::director();
    }
    ...
    {
        return \Tests\Feature\Fixture\Stash\Fields\ScrapedMovieField::url();
    }
    ...
    {
        return \Tests\Feature\Fixture\Stash\Fields\ScrapedMovieField::urls();
    }
    ...
    {
        return \Tests\Feature\Fixture\Stash\Fields\ScrapedMovieField::synopsis();
    }

    /**
     * @return \Tests\Feature\Fixture\Stash\Fields\ScrapedMovieField<\Tests\Feature\Fixture\Stash\SelectionSet\ScrapedStudioSelectionSet>
     */
    public static function studio(): Fields\ScrapedMovieField
    {
        return \Tests\Feature\Fixture\Stash\Fields\ScrapedMovieField::studio();
    }

    /**
     * @return \Tests\Feature\Fixture\Stash\Fields\ScrapedMovieField<\Tests\Feature\Fixture\Stash\SelectionSet\ScrapedTagSelectionSet>
     */
    public static function tags(): Fields\ScrapedMovieField
    {
        return \Tests\Feature\Fixture\Stash\Fields\ScrapedMovieField::tags();
    }
    ...
    {
        return \Tests\Feature\Fixture\Stash\Fields\ScrapedMovieField::front_image();
    }
    ...
    {
        return \Tests\Feature\Fixture\Stash\Fields\ScrapedMovieField::back_image();
    }
