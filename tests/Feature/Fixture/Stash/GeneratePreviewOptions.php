...
class GeneratePreviewOptions implements \Aazsamir\Graphpql\Model\GraphObject
{
    ...
    /**
     * @return \Tests\Feature\Fixture\Stash\Fields\GeneratePreviewOptionsField<mixed>
     */
    public static function previewSegments(): Fields\GeneratePreviewOptionsField
    {
        return \Tests\Feature\Fixture\Stash\Fields\GeneratePreviewOptionsField::previewSegments();
    }
    ...
    {
        return \Tests\Feature\Fixture\Stash\Fields\GeneratePreviewOptionsField::previewSegmentDuration();
    }
    ...
    {
        return \Tests\Feature\Fixture\Stash\Fields\GeneratePreviewOptionsField::previewExcludeStart();
    }
    ...
    {
        return \Tests\Feature\Fixture\Stash\Fields\GeneratePreviewOptionsField::previewExcludeEnd();
    }
    ...
    {
        return \Tests\Feature\Fixture\Stash\Fields\GeneratePreviewOptionsField::previewPreset();
    }
